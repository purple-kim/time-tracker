...
현재 고양이는 노트북을 타이핑하는 모습으로 움직입니다. 브라운 고양이와 블랙 고양이 중 하나를 고를 수 있고, 타이머가 켜져 있을 때는 타이핑 소리도 함께 들을 수 있습니다.
...
- `고양이 테마`: 브라운 고양이 또는 블랙 고양이를 선택합니다.
...
- 현재 지원하는 고양이 테마는 브라운 고양이와 블랙 고양이입니다.
